<template>
    ...
    <div>
        <Buttons>你好</Buttons>
        <Buttons theme="button">你好</Buttons>
    ...
    <div>
        <Buttons size="big" theme="link">大大大</Buttons>
    ...
    <div>
        <Buttons level="main" theme="link">主要链接按钮</Buttons>
        <Buttons theme="link">普通链接按钮</Buttons>
        <Buttons level="danger" theme="link">危险链接按钮</Buttons>
    </div>
    <div>
